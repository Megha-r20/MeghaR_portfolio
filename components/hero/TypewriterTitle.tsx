...
export const TypewriterTitle = () => {
  ...
  return (
    <span className="relative inline-flex flex-col items-center justify-center text-[#b40023]/90 uppercase text-[11px] md:text-sm tracking-[0.3em] font-semibold mt-4">
      ...
      <span className="absolute inset-0 flex items-center justify-center whitespace-nowrap">
        ...
        <motion.span
          ...
          className="inline-block w-[2px] h-[1.1em] bg-[#b40023]/90 ml-1 md:ml-1.5 rounded-full"
        />
      </span>
    </span>
  );
