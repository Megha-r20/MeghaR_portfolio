...
function SkillRow({ name, index }: { name: string; index: number }) {
  ...
  return (
    <div
      className="group/skill relative cursor-default border-b border-[#3a2a1c]/15 hover:border-[#b40023]/30 transition-all duration-500"
      onMouseMove={handleMouseMove}
      onMouseLeave={handleMouseLeave}
      style={{ perspective: "800px" }}
    >
      <motion.div
        className="flex items-center justify-between py-4 px-4 -mx-4 transition-all duration-300 origin-center group-hover/skill:bg-[#353545]/[0.02]"
        style={{
          rotateX,
          rotateY,
          x: shiftX,
      ...
      >
        ...
        <div className="absolute left-0 top-0 w-[3px] h-full bg-[#b40023] scale-y-0 group-hover/skill:scale-y-100 transition-transform duration-300 origin-top" />

        {/* Skill name */}
        <span 
          className="font-sans text-sm text-[#353545]/70 group-hover/skill:text-[#353545] transition-all duration-300"
        ...
        {/* Index number */}
        <span 
          className="font-researcher text-xs tracking-wider text-[#353545]/30 group-hover/skill:text-[#b40023] transition-all duration-300"
    ...
    <section ref={sectionRef} className="px-6 md:px-12 relative py-[120px] md:py-[140px]">
      ...
      <div className="max-w-[1600px] mx-auto w-full">
        ...
        >
          ...
          <span className="text-[#b40023] font-black text-[13px] md:text-[15px] tracking-[0.4em]">Expertise</span>
        </div>
      </div>
