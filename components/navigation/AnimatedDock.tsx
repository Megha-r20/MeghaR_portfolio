...
export const DockItem = ({ mouseX, children }: DockItemProps) => {
  ...
  return (
    <motion.div
      ref={ref}
      style={{ width }}
      className="aspect-square w-9 rounded-full bg-[#353545] text-white flex items-center justify-center cursor-pointer hover:bg-[#b40023] transition-colors duration-300 shadow-sm"
    >
      <motion.div
